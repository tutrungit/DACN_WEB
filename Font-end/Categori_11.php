				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/LG-Q8.jpg" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/LG-Q8.jpg"/>
					</div>
			</article>			  			
			</div>
		</div>
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">IPS LCD, 5.2"Quad HD </span>
					</li>
					<!--<li>
					...
					<li>
						<label>CPU :</label>
						<span>Snapdragon 820 4 nhân<br> 64 bit</span>
					</li>
				</ul>
			</div>			
			<div class="thongtin margin_top_20" style="margin-left: 20px">
				<ul type="disc">
					<li>
						<label>Camera:</label>
						<span style="display: inline-block">Chính: 16 MP, Phụ: 2 Camera 8 MP</span>
					</li>
					<li>
						<label>Ram:</label>
						<span> 4 GB</span>	
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của LG Q8</h3>
			<div class="thong_tin">
