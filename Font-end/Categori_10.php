				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/lg-g6-pro-32gb-gia-re-xach-tay-uy-tin-tai-hai-phong-vinh.jpg" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/lg-g6-pro-32gb-gia-re-xach-tay-uy-tin-tai-hai-phong-vinh.jpg"/>
					</div>
			</article>			  			
			</div>
		</div>
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">IPS LCD 5,7"</span>
					</li>
					<!--<li>
					...
					<li>
						<label>CPU :</label>
						<span>2 nhân 2.3 GHz Kryo & 2 nhân<br> 1.6 GHz Kryo</span>
					</li>
				</ul>
			</div>			
			<div class="thongtin margin_top_20" style="margin-left: 20px">
				<ul type="disc">
					<li>
						<label>Camera:</label>
						<span style="display: inline-block">Chính: 16 MP, Phụ: 16 MP</span>
					</li>
					<li>
						<label>Ram:</label>
						<span> 3 GB</span>	
				...
				<div class="col-lg-12 col-md-12 col-sm-6 col-zs-12 mua_hang_1" style="margin-top: 20px;">
					<div class="dat_hang">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 dat_hang_2">
							<button class="btn btn-default">Mua TRẢ GÓP<br><span> Chỉ từ 15,240,000đ</span>
							</button>
						</div>
					</div>
	  ...
	  <!-- Tab panes -->
			<div class="tab-content" style="margin-top: 20px">
				...
				<div role="tabpanel" class="tab-pane" id="profile">
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/LG-Optimus-L9-P760-l.jpg">
							<h5>LG Optimus L9 P768</h5>
							<strong>2.190.000 ₫</strong>
						</a>
					</div>
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/LG_G3_d855-200x150.jpg" width="400px">
							<h5>LG X </h5>
					...
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/images (3).jpg" width="300px">
							<h5>LG Optimus G </h5>
							<strong>3.990.000 ₫</strong>
						</a>
					</div>
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/dien-thoai-lg-v10-720x500-500x500.jpg" width="300px" height="300px">
							<h5>LG V10</h5>
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của LG G6 Pro</h3>
			<div class="thong_tin">
