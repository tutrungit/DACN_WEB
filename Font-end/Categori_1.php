...
<div class="	container margin_top_20	">
	<div class="row">
		<div class="header">
			...
			<a href="#"> Samsung   |</a>
			<b><span>Samsung Galaxy J7 pro</span></b>
		</div>
	</div>
</div>
				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/issac_1.jpg" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/issac_1.jpg"">
						</div>
					</div>
				</article>			  			
			</div>
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">Super AMOLED, 5.5", Full HD</span>
					</li>
					<!--<li>
					...
					<li>
						<label>CPU :</label>
						<span>Exynos 7870 8 nhân<br> 64 bit</span>
					</li>
				</ul>
			</div>			
