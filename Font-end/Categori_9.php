...
<div class="	container margin_top_20	">
	<div class="row">
		<div class="header">
			...
			<a href="#"> Iphone   |</a>
			<b><span>Iphone 7s Plus 32GB </span></b>
		</div>
	</div>
</div>
...
<div class="container " style="background-color:white">
	<div class="row">
		<div class="col-xs-12">
			<div class="tieu_de">
				<h2>Iphone 7 Plus 32 GB</h2>
				<span>(No.01345714)</span>
			</div>
		</div>
				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/1-Tamo-iphone7_battery_case-rose-gold-front_back-min.png" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/1-Tamo-iphone7_battery_case-rose-gold-front_back-min.png">
						</div>
					</div>
				</article>			  			
			</div>
		...
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">LED-backlit LCD 5.5" </span>
					</li>
					<!--<li>
					...
					<li>
						<label>CPU :</label>
						<span>	Apple A10 Fusion 4 nhân<br>64 bit</span>
					</li>
				</ul>
			</div>			
			<div class="thongtin margin_top_20" style="margin-left: 20px">
				<ul type="disc">
					<li>
						<label>Camera:</label>
						<span style="display: inline-block">Chính: 7.0 MP, Phụ: 2 Camera 12 MP</span>
					</li>
					<li>
						<label>Ram:</label>
						<span> 3 GB</span>	
				...
				<div role="tabpanel" class="tab-pane" id="profile">
					...
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							...
							<h5>Iphone 6s plush </h5>
							<strong>10.490.000 ₫</strong>
						</a>
					</div>
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/IPHONE_1.png">
							<h5>I phone 5</h5>
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của iphone 7 Plus 32 GB</h3>
			<div class="thong_tin">
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 tin_tuc" style="margin-top: 10px">	
			<div class="nd_tt">
				<h2>Bài viết về Iphone 7 Plus 32 GB</h2>
				<div class="inform_tt">
					<ul>
						<li>
