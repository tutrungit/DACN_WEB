				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/sony-xperia-xzs-3439474562-jpg.jpg" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/sony-xperia-xzs-3439474562-jpg.jpg">
						</div>
					</div>
				</article>			  			
			</div>
