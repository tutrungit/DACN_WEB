				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/iphone-7-gold_6e02-ls.jpg" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/iphone-7-gold_6e02-ls.jpg">
						</div>
					</div>
				</article>			  			
			</div>
		...
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					...
					<li>
						<label>CPU :</label>
						<span>Apple A8 2 nhân 64-bit 2 Nhân<br> 4 GH</span>
					</li>
				</ul>
			</div>			
	  ...
	  <!-- Tab panes -->
			<div class="tab-content" style="margin-top: 20px">
				...
				<div role="tabpanel" class="tab-pane" id="profile">
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/IPHONE_1.png" width="250px" height="200px">
							<h5>Iphone 5</h5>
							<strong>4.520.000 ₫</strong>
						</a>
					</div>
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/IPHONE_2.png" width="200px" height="200px">
							<h5>Iphone 5s</h5>
					...
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/iphone-7-8-400x460.png" width="200px" height="200px">
							<h5>Iphone 7s gold</h5>
							<strong>12.990.000 ₫</strong>
						</a>
				</div>
				<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/IPHONE_3.png" width="200px" height="200px">
							<h5>Iphone 6s</h5>
							<strong>12.990.000 ₫</strong>
						</a>
				</div>
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của Iphone 6s</h3>
			<div class="thong_tin">
