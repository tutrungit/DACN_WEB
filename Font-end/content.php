<?php
session_start();
include "../Back-end/pages/config.php";

include ROOT."/include/function.php";

include "Back-end/pages/autoload.php";
$db= new Db();
$cart = new Cart();
?>
		<!doctype html>
...
<link rel="stylesheet" href="../Back-end/dist/css/stylevivo.css"
	...
	<div class="header">
		<div class="header_top">
			...
			<div class="logo">
			    ...
			    <div class="shopping_cart">
					<div class="cart">
						<a href="#" title="View my shopping cart" rel="nofollow">
							...
							<a href="giohang.php"><span class="cart_title">Giỏ hàng(
			   ...
			   <a href="dangky.html"><button class="btn btn-default"><span class="glyphicon glyphicon-off"></span> Đăng ký</button></a>
	 		</div>
	 	</div>
	  </div>
  </div>
				...
				<div class="col-lg-12 col-md-12 col-sm-6 col-zs-12 mua_hang_1" style="margin-top: 20px;">
					<div class="dat_hang">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 dat_hang_2">
							<button class="btn btn-default">Mua TRẢ GÓP<br><span> Chỉ từ 1,516,000đ</span> 
							</button>
						</div>
					</div>
