...
<div class="	container margin_top_20	">
	<div class="row">
		<div class="header">
			...
			<a href="#"> OPPO  |</a>
			<b><span>OPPO F3 Lite A57</span></b>
		</div>
	</div>
</div>
...
<div class="container " style="background-color:white">
	<div class="row">
		<div class="col-xs-12">
			<div class="tieu_de">
				<h2>OPPO F3 Lite A57 </h2>
				<span>(No.03445224)</span>
			</div>
		</div>
				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/f3-lite-gold_1497322416.jpg" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/f3-lite-gold_1497322416.jpg">
						</div>
					</div>
				</article>			  			
			</div>
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">5.2 inch (720 x 1280 pixels) </span>
					</li>
					<!--<li>
					...
					<li>
						<label>Pin:</label>
						<span>Non-removable Li-Ion 3200 mAh battery</span>	
					</li>
					<li>
						<label>CPU :</label>
						<span>	Qualcomm MSM8940 <br> 64 bit</span>
					</li>
				</ul>
			</div>			
				...
				<div class="col-lg-12 col-md-12 col-sm-6 col-zs-12 mua_hang_1" style="margin-top: 20px;">
					<div class="dat_hang">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 dat_hang_2">
							<button class="btn btn-default">Mua TRẢ GÓP<br><span> Chỉ từ 4,240,000đ</span> 
							</button>
						</div>
					</div>
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của OPPO F3 Lite A57</h3>
			<div class="thong_tin">
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 tin_tuc" style="margin-top: 10px">	
			<div class="nd_tt">
				<h2>Bài viết về OPPO F3 Lite A57</h2>
				<div class="inform_tt">
					<ul>
						<li>
