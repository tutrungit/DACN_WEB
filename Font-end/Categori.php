...
<div class="	container margin_top_20	">
	<div class="row">
		<div class="header">
			...
			<a href="#"> Samsung   |</a>
			<b></b><span>Samsung Galaxy Note 8</span></b>
		</div>
	</div>
</div>
				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/636372640927402700_1.jpg" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/636372640927402700_1.jpg">
						</div>
					</div>
				</article>			  			
			</div>
		...
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">Super AMOLED 6.3" 2K</span>
					</li>
					<!--<li>
					...
					<li>
						<label>Pin:</label>
						<span> 3300 mAh, có sạc nhanh</span>	
					</li>
					<li>
						<label>CPU :</label>
						<span>	Exynos 8895 8 nhân<br> 64 bit</span>
					</li>
				</ul>
			</div>			
			<div class="thongtin margin_top_20" style="margin-left: 20px">
				<ul type="disc">
					<li>
						<label>Camera:</label>
						<span style="display: inline-block">Chính: 8 MP, Phụ: 2 camera 12 MP</span>
					</li>
					<li>
						<label>Ram:</label>
						<span> 6 GB</span>	
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của Samsung Galaxy Note 8</h3>
			<div class="thong_tin">
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 tin_tuc" style="margin-top: 10px">	
			<div class="nd_tt">
				<h2>Bài viết về Samsung Galaxy Note 8</h2>
				<div class="inform_tt">
					<ul>
						<li>
