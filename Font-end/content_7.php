				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/DE8zlcjWAAEwg5M.jpg" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/DE8zlcjWAAEwg5M.jpg">
						</div>
					</div>
				</article>			  			
			</div>
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">IPS LCD, 5.3", Quad HD (2K)</span>
					</li>
					<!--<li>
					...
					<li>
						<label>CPU :</label>
						<span>	Qualcomm Snapdragon 835 8 nhân 64-bit</span>
					</li>
				</ul>
			</div>			
...
<div  class="col-lg-4 col-md-4 col-sm-6 col-xs-12 inform " style="margin-left: 15px;">
				...
				<div class="khung_inform">
					...
					<ul type="disc">
						...
						<li>Pin sạc dự phòng 7500mah (Nếu không có quà sẽ hoàn 200,000đ) <a href="#">Xem chi tiết</a></li>
					</ul>
				</div>
				<div class="chon_mau">
					<h3>Chọn màu: </h3>
	  ...
	  <!-- Tab panes -->
			<div class="tab-content" style="margin-top: 20px">
				...
				<div role="tabpanel" class="tab-pane" id="profile">
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/Nokia 6.png" width="200px" height="200px">
							<h5>NoKia 6</h5>
							<strong>6.220.000 ₫</strong>
						</a>
					</div>
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/nokia-1424-338531-1-zoom.jpg" width="200px" height="200px">
							<h5>NoKia 1424</h5>
					...
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/nokia-216-9-300x300.jpg" width="200px" height="200px">
							<h5>NoKia 216</h5>
				...
				<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/nokia-3-2-300x300.jpg" width="200px" height="200px">
							<h5>NoKia 3</h5>
							<strong>4.930.000 ₫</strong>
						</a>
				</div>
			</div>
		</div>
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của NoKia</h3>
			<div class="thong_tin">
