				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/mua-tra-gop-dien-thoai-oppo-f3-plus_5.jpg" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/mua-tra-gop-dien-thoai-oppo-f3-plus_5.jpg">
						</div>
					</div>
				</article>			  			
			</div>
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">IPS LCD, 6", Full HD </span>
					</li>
					<!--<li>
					...
					<li>
						<label>CPU :</label>
						<span>Snapdragon 653 CPU 1.8 GHz <br> 64 bit</span>
					</li>
				</ul>
			</div>			
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của OPPO F3 Plus</h3>
			<div class="thong_tin">
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 tin_tuc" style="margin-top: 10px">	
			<div class="nd_tt">
				<h2>Bài viết về OPPO F3 Plus</h2>
				<div class="inform_tt">
					<ul>
						<li>
