				...
				<!--<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/oppo_a37_16gb_dual_sim_rose_gold.jpg" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/oppo_a37_16gb_dual_sim_rose_gold.jpg">
						</div>
					</div>
				</article>-->	
...
<div  class="col-lg-4 col-md-4 col-sm-6 col-xs-12 inform " style="margin-left: 15px;">
				...
				<div class="khung_inform">
					...
					<ul type="disc">
						...
						<li>Tặng Sim 4G lướt web cực nhanh</li>
						<h2>KHÁCH HÀNG ĐƯỢC THÊM KHUYẾN MẠI:</h2>
						<li>Cơ hội Trúng 100 xe vision & nhiều phần quà hấp dẫn khác <a href="#">Xem chi tiết</a></li>
					</ul>
				</div>
				<div id="gallery_01">
				<div class="chon_mau">
				...
				<div class="col-lg-12 col-md-12 col-sm-6 col-zs-12 mua_hang_1" style="margin-top: 20px;">
					<div class="dat_hang">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 dat_hang_2">
							<button class="btn btn-default">Mua TRẢ GÓP<br><span> Chỉ từ 1,997,500đ</span> 
							</button>
						</div>
					</div>
