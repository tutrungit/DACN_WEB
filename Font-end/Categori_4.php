...
<div class="	container margin_top_20	">
	<div class="row">
		<div class="header">
			...
			<a href="#"> Mobiistar  |</a>
			<b></b><span>Mobiistar Zumbo S2 Dual</span></b>
		</div>
	</div>
</div>
...
<div class="container " style="background-color:white">
	<div class="row">
		<div class="col-xs-12">
			<div class="tieu_de">
				<h2>Mobiistar Zumbo S2 Dual</h2>
				<span>(No.02352687)</span>
			</div>
		</div>
				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/636308130444410442_zumbo800black.jpg" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/636308130444410442_zumbo800black.jpg">
						</div>
					</div>
				</article>			  			
			</div>
		...
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">5.5 inch (1920 x 1080 </span>
					</li>
					<!--<li>
					...
					<li>
						<label>CPU :</label>
						<span> MTK MT6737T, 4 Nhân, 1.3 GHz<br> 64 bit</span>
					</li>
				</ul>
			</div>			
			<div class="thongtin margin_top_20" style="margin-left: 20px">
				<ul type="disc">
					<li>
						<label>Camera:</label>
						<span style="display: inline-block">Chính: 13 MP, Phụ: 13 MP</span>
					</li>
					<li>
						<label>Ram:</label>
						<span> 3 GB</span>	
...
<div  class="col-lg-4 col-md-4 col-sm-6 col-xs-12 inform " style="margin-left: 15px;">
				...
				<div class="khung_inform">
					...
					<ul type="disc">
						...
						<li>Bao da LED View Samsung chính hãng ( áp dụng từ ngày 04/11)</li>
						<li>Tặng PMH Phụ Kiện 100,000đ khi mua Online</li>
						<h2>KHÁCH HÀNG ĐƯỢC THÊM KHUYẾN MẠI:</h2>
						<li>Cơ hội Trúng 100 xe SH150i & nhiều phần quà hấp dẫn  <a href="#">Xem chi tiết</a></li>
					</ul>
				</div>
				<div class="chon_mau">
					<h3>Chọn màu: </h3>
				...
				<div class="col-lg-12 col-md-12 col-sm-6 col-zs-12 mua_hang_1" style="margin-top: 20px;">
					<div class="dat_hang">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 dat_hang_2">
							<button class="btn btn-default">Mua TRẢ GÓP<br><span> Chỉ từ 2,240,000đ</span> 
							</button>
						</div>
					</div>
			...
			<div class="tab-content" style="margin-top: 20px">
				<div role="tabpanel" class="tab-pane active" id="home">
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/iphone-7-9-300x300.jpg" width="192px" height="192px">
							<h5>Iphone 7</h5>
					...
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/dien-thoai-di-dong-vivo-y51-den-mt1 (1).jpg" width="200px" height="200px">
							<h5>Vivo y51 đen</h5>
				...
				<div role="tabpanel" class="tab-pane" id="profile">
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/mobiistar-lai-zumbo-j-300x300.jpg" width="200px" height="200px">
							<h5>Mobiistar Lai Zumbo</h5>
							<strong>1.200.000 ₫</strong>
						</a>
					</div>
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/mobiistar-lai-zoro-2-300x300.jpg" width="200px" height="200px">
							<h5>Mobiistar Lai Zoro 2</h5>
							<strong>2.990.000 ₫</strong>
						</a>
					</div>
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/mobiistar-prime-x-2017-1-400x460.png" width="200px" height="200px">
							<h5>Mobiistar Prime X (2017) </h5>
							<strong>4.990.000 ₫</strong>
						</a>
					</div>
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/mobiistar-touch-bean-402-300-nowatermark-300x300.jpg"width="200px" height="200px">
							<h5>Mobiistar touch bean 402 </h5>
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của Mobiistar Zumbo S2 Dual</h3>
			<div class="thong_tin">
				...
				<ul class="show_tt">
					...
					<li>
						...
						<span>MicroSD hỗ trợ đến 12GB</span>
					</li>
					<li>
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 tin_tuc" style="margin-top: 10px">	
			<div class="nd_tt">
				<h2>Bài viết về  Mobiistar Zumbo S2 Dual</h2>
				<div class="inform_tt">
					<ul>
						<li>
