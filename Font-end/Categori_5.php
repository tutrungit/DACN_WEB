...
<div class="	container margin_top_20	">
	<div class="row">
		<div class="header">
			...
			<a href="#"> Mobiistar  |</a>
			<b></b><span>Mobiistar Prim X1</span></b>
		</div>
	</div>
</div>
...
<div class="container " style="background-color:white">
	<div class="row">
		<div class="col-xs-12">
			<div class="tieu_de">
				<h2>Mobiistar Prim X1</h2>
				<span>(No.02124587)</span>
			</div>
		</div>
				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/100000_mobiistar-prime-x1-1-2.jpg" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/100000_mobiistar-prime-x1-1-2.jpg">
						</div>
					</div>
				</article>			  			
			</div>
		...
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">5.2 inches (720 x 1280 pixels) </span>
					</li>
					<!--<li>
			...
			<div class="thongtin margin_top_20" style="margin-left: 20px">
				<ul type="disc">
					<li>
						<label>Camera:</label>
						<span style="display: inline-block">Chính: 13 MP, Phụ: 16 MP</span>
					</li>
					<li>
						<label>Ram:</label>
						<span> 2 GB</span>	
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của Mobiistar Prim X1</h3>
			<div class="thong_tin">
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 tin_tuc" style="margin-top: 10px">	
			<div class="nd_tt">
				<h2>Bài viết về  Mobiistar Prim X1</h2>
				<div class="inform_tt">
					<ul>
						<li>
