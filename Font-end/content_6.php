...
<div class="	container margin_top_20	">
	<div class="row">
		<div class="header">
			...
			<a href="#"> MOBIISTAR  |</a>
			<b></b><span>Mobiistar Lai Yuna S1 </span></b>
		</div>
	</div>
</div>
...
<div class="container " style="background-color:white">
	<div class="row">
		<div class="col-xs-12">
			<div class="tieu_de">
				<h2> Mobiistar Lai Yuna S1</h2>
				<span>(No.02233536)</span>
			</div>
		</div>
				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/Mobiistar-LAI-Yuna-S1.png" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/Mobiistar-LAI-Yuna-S1.png">
						</div>
					</div>
				</article>			  			
			</div>
		...
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">5.0 inch (1334 x 750 pixels)</span>
					</li>
					<!--<li>
			...
			<div class="thongtin margin_top_20" style="margin-left: 20px">
				<ul type="disc">
					<li>
						<label>Camera:</label>
						<span style="display: inline-block">Chính: 13 MP và 8 MP</span>
					</li>
					<li>
						<label>Ram:</label>
						<span> 3 GB</span>	
...
<div  class="col-lg-4 col-md-4 col-sm-6 col-xs-12 inform " style="margin-left: 15px;">
				...
				<div class="khung_inform">
					...
					<h2>KM1:</h2>
					<ul type="disc">
						<li>Phiếu mua hàng trị giá 350.000đ khi mua sản phẩm tại tgdd</li>
					</ul>
					<h2>KM2:</h2>
					<ul type="disc">
				...
				<div class="col-lg-12 col-md-12 col-sm-6 col-zs-12 mua_hang_1" style="margin-top: 20px;">
					<div class="dat_hang">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 dat_hang_2">
							<button class="btn btn-default">Mua TRẢ GÓP<br><span> Chỉ từ 2,000,000đ</span> 
							</button>
						</div>
					</div>
	  ...
	  <!-- Tab panes -->
			<div class="tab-content" style="margin-top: 20px">
				...
				<div role="tabpanel" class="tab-pane" id="profile">
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/636308130444410442_zumbo800black.jpg" width="200px" height="200px">
							<h5>Mobiistar S</h5>
				...
				<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							...
							<h5>Mobiistar-prime-x</h5>
							<strong>10.330.000 ₫</strong>
						</a>
				</div>
			</div>
		</div>
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của Mobiistar</h3>
			<div class="thong_tin">
				...
				<ul class="show_tt">
					...
					<li>
						...
						<span>MicroSD hỗ trợ đến 189GB</span>
					</li>
					<li>
