				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/MKY02_AV1_SPACE_GRAY.jpg" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/MKY02_AV1_SPACE_GRAY.jpg">
						</div>
					</div>
				</article>			  			
			</div>
		...
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block"> 4.7 inch (1334 x 750 pixels) </span>
					</li>
					<!--<li>
					...
					<li>
						<label>Pin:</label>
						<span>Lithium - Ion 1810mAh</span>	
					</li>
					<li>
						<label>CPU :</label>
						<span> Apple A8 2 nhân 64-bit, 2 Nhân<br>1,4 GH</span>
					</li>
				</ul>
			</div>			
			<div class="thongtin margin_top_20" style="margin-left: 20px">
				<ul type="disc">
					<li>
						<label>Camera:</label>
						<span style="display: inline-block">Chính: 8.0 MP, Phụ: 1.2 MP</span>
					</li>
					<li>
						<label>Ram:</label>
						<span> 1 GB</span>	
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của iphone 6s 32 GB</h3>
			<div class="thong_tin">
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 tin_tuc" style="margin-top: 10px">	
			<div class="nd_tt">
				<h2>Bài viết về Iphone 6s 32 GB</h2>
				<div class="inform_tt">
					<ul>
						<li>
