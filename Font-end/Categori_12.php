				...
				<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/Nokia 6.png" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/Nokia 6.png"/>
					</div>
			</article>			  			
			</div>
		</div>
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">IPS LCD, 5.5", Full HD</span>
					</li>
					<!--<li>
					...
					<li>
						<label>CPU :</label>
						<span>Qualcomm Snapdragon 430 8 nhân<br> 64 bit</span>
					</li>
				</ul>
			</div>			
				...
				<div class="col-lg-12 col-md-12 col-sm-6 col-zs-12 mua_hang_1" style="margin-top: 20px;">
					<div class="dat_hang">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 dat_hang_2">
							<button class="btn btn-default">Mua TRẢ GÓP<br><span> Chỉ từ 5,240,000đ</span>
							</button>
						</div>
					</div>
	  ...
	  <!-- Tab panes -->
			<div class="tab-content" style="margin-top: 20px">
				...
				<div role="tabpanel" class="tab-pane" id="profile">
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/nokia-216-9-300x300.jpg">
							<h5>Nokia 2016</h5>
					...
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/nokia-8-1-400x460.png" width="300px" height="300px">
							<h5>Nokia 8</h5>
					...
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/nokia-1424-338531-1-zoom.jpg" width="300px">
							<h5>Nokia Lumia </h5>
							<strong>3.990.000 ₫</strong>
						</a>
					</div>
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/nokia-3-2-300x300.jpg" width="28	0px" >
							<h5>Nokia 3 </h5>
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của Nokia 6</h3>
			<div class="thong_tin">
