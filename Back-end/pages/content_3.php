...
<div class="	container margin_top_20	">
	<div class="row">
		<div class="header">
			...
			<a href="#"> ASSUS    |</a>
			<b><span>ASSUS Zenphone 3 </span></b>
		</div>
	</div>
</div>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="tieu_de">
				<?php
		        $obj = new Dongdt();
		        $data = $obj->getOne('AS01');
		        foreach ($data as $r) {
		       
				?>
				<h2><?php echo $r['TenDongDT']; ?> </h2>
				<span>(No.02233534)</span>
			</div>
		</div>
				...
				<!--<article class="body">
					<div class="wm-zoom-container my-zoom-1">
						<div class="wm-zoom-box">
							<img src="images/asus-zenfone-3-max-5-5-zc553kl-551748303-jpg.jpg" class="img-responsive" class="jq-zoom-default-img"  alt="alternative text" data-hight-src="images/asus-zenfone-3-max-5-5-zc553kl-551748303-jpg.jpg">
						</div>
					</div>
				</article>	-->		  
				<img id="img_01" src="images/asus-zenfone-3-max-5-5-zc553kl-551748303-jpg.jpg" data-zoom-image="images/asus-zenfone-3-max-5-5-zc553kl-551748303-jpg.jpg" class="img-responsive" /> 				
			</div>
		</div>
		<div  class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="background-color: white">
			...
			<div class="thong_tin margin_top_20">
				<ul type="disc">
					<li>
						...
						<span style="display: inline-block">Super IPS LCD, 5.5", Full HD</span>
					</li>
					<!--<li>
					...
					<li>
						<label>CPU :</label>
						<span>	Snapdragon 625 8 nhân<br> 64 bit</span>
					</li>
				</ul>
			</div>			
			<div class="thongtin margin_top_20" style="margin-left: 20px">
				<ul type="disc">
					<li>
						<label>Camera:</label>
						<span style="display: inline-block">Chính: 16 MP, Phụ: 8 MP</span>
					</li>
					<li>
						<label>Ram:</label>
						<span> 4 GB</span>	
...
<div  class="col-lg-4 col-md-4 col-sm-6 col-xs-12 inform " style="margin-left: 15px;">
				...
				<!--	<h3>CHƯƠNG TRÌNH KHUYẾN MẠI ĐẶC BIỆT ĐẾN 30/11:KHÁCH HÀNG CHỌN 1 TRONG 2 KHUYẾN MẠI SAU:</h3>
					<h2>KM1:</h2>-->
					<ul type="disc">
						<li>Phiếu mua hàng trị giá 500.000đ khi mua sản phẩm tại tgdd</li>
					</ul>
					<!--<h2>KM2:</h2>
					<ul type="disc">
						<li>Trả góp 0% Hoặc 100% trúng PMH Phụ Kiện/ Dịch Vụ từ 150,000đ đến 10,000,000đ <a href="#">Xem chi tiết</a></li>
						<li>Tặng PMH Phụ Kiện 100,000đ</li>
						<li>Tặng Balo thởi trang cho 10 người đầu tiên </li>
						<h2>KHÁCH HÀNG ĐƯỢC THÊM KHUYẾN MẠI:</h2>
						<li>Cơ hội Trúng 100 i phone X & nhiều phần quà hấp dẫn khác <a href="#">Xem chi tiết</a></li>
					</ul>-->
				</div>
				<div id="gallery_01">
				<div class="chon_mau">
					<h3>Chọn màu: </h3>
					<a href="javascript:void(0)" data-image="images/asus-zenfone3-den.jpg" data-zoom-image="images/asus-zenfone3-den.jpg"  width="400px">
							<div class="mau"></div>
						</a>
					<a href="javascript:void(0)" data-image="images/asus-zenfone-3-blue.jpg" data-zoom-image="images/asus-zenfone-3-blue.jpg"  width="400px">
							<div class="mau_1"></div>
						</a>	
					<a href="#">
						<div class="mau_2"></div>
	  ...
	  <!-- Tab panes -->
			<div class="tab-content" style="margin-top: 20px">
				...
				<div role="tabpanel" class="tab-pane" id="profile">
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/asus-zenfone-go-zc500tg-300x300.jpg" width="200px" height="200px">
							<h5>Assus Zenfone Go</h5>
							<strong>2.520.000 ₫</strong>
						</a>
					</div>
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/asus-zenfone-2-go-zb500kg-300-300x300.jpg" width="200px" height="200px">
							<h5>Assus Zenfone 2 Go</h5>
							<strong>2.220.000 ₫</strong>
						</a>
					</div>
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/asus-zenfone-3-max-8-300x300.jpg" width="200px" height="200px">
							<h5>Asus Zenfone 3 Max</h5>
							<strong>3.990.000 ₫</strong>
						</a>
					</div>
					<div class="col-lg-3 colg-md-3 col-sm-6 col-xs-12 content_dt">
						<a href="#">
							<img src="images/615859804_asus-zenfone-3-ze520kl-64g-ram-4g.jpg">
							<h5>Assus Zenfone</h5>
...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 thong_so">
			<h3>Thông số kỹ thuật của Assus zenfone 3</h3>
			<div class="thong_tin">
				...
				<ul class="show_tt">
					...
					<li>
						<label>Hệ Điều hành</label>
						<span> Android 6.0 (Marshmallow)</span>
					</li>
				</ul>
			</div>
		</div> 
		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 tin_tuc" style="margin-top: 10px">	
			<div class="nd_tt">
				<h2>Bài viết về Assus zenfone 3</h2>
				<div class="inform_tt">
					<ul>
						<li>
